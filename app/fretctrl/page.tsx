  ...
  return (
    <div className="min-h-screen lg:h-screen w-full bg-white text-neutral-900 flex flex-col justify-between p-4 sm:p-6 lg:p-8 font-sans select-none overflow-y-auto lg:overflow-hidden no-scrollbar">
      ...
      <header className="w-full flex justify-between items-center pb-4 flex-shrink-0">
        <Link
          href="/"
          className="text-sm font-mono text-neutral-500 hover:text-black transition-colors"
        >
          /fretctrl
        </Link>
        <Link
      ...
      <main className="flex-1 w-full flex flex-col lg:flex-row gap-6 lg:gap-10 xl:gap-14 min-h-0 py-2 lg:overflow-hidden no-scrollbar">
        ...
        <div className="w-full lg:w-[16%] flex-shrink-0">
          <span className="text-sm font-normal text-neutral-400 font-sans block">
            product overview
          </span>
        </div>
        ...
        <div className="w-full lg:w-[46%] xl:w-[48%] h-full min-h-0 flex flex-col justify-between py-1 lg:overflow-y-auto select-text pr-2 no-scrollbar">
          <div className="space-y-6">
            ...
            <div className="pt-2">
              ...
              <div className="space-y-4 text-[16px] sm:text-[17px] leading-[1.6] text-neutral-800 font-normal max-w-xl">
        ...
        <div className="w-full lg:w-[38%] xl:w-[36%] h-[350px] sm:h-[450px] lg:h-full flex-shrink-0 relative bg-neutral-900 overflow-hidden flex items-center justify-center">
          <img
            src="https://i.pinimg.com/1200x/cf/74/01/cf7401b52f90708569cbfaae9b36cf61.jpg"
            alt="FRETCTRL"
